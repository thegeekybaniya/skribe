/**
 * @fileoverview Home screen for room creation and joining
...
/**
 * HomeScreen component - placeholder for room creation and joining
 * This will be fully implemented in task 15
 */
export const HomeScreen: React.FC = observer(() => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Skribbl Clone</Text>
